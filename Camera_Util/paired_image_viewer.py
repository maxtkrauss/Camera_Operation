...
thorlabs_image_folder = 'images//bifringence//thorlabs'
cubert_image_folder = 'images//bifringence//cubert'

# thorlabs_image_folder = 'E:\\NASA_HSI\\paired_image_datasets\\ground_glass\\grey2HSI_12-12\\thorlabs'
# cubert_image_folder = 'E:\\NASA_HSI\\paired_image_datasets\\ground_glass\\grey2HSI_12-12\\cubert'

#thorlabs_image_folder = 'E:\\NASA_HSI\\paired_polarization_datasets\\polarization\\45_degree_new\\thorlabs'
#cubert_image_folder = 'E:\\NASA_HSI\\paired_polarization_datasets\\polarization\\45_degree_new\\cubert'

#thorlabs_image_folder = 'D:\\NASA_HSI\\gg_filter_test_3\\train\\thorlabs'
#cubert_image_folder = 'D:\\NASA_HSI\\gg_filter_test_3\\train\\cubert'
...
def load_cb_image(cb_file):
    ...
    #cb_image = cb_image[:, crop_cb[1][0]:crop_cb[1][1], crop_cb[0][0]:crop_cb[0][1]]
    return cb_image
...
def load_tl_image(tl_file):
    ...
    #tl_image = tl_image[:, crop_tl[1][0]:crop_tl[1][1], crop_tl[0][0]:crop_tl[0][1]]
    return tl_image
